#ifndef FOO_LIB_INTERPRETER_EVALUATOR_H
#define FOO_LIB_INTERPRETER_EVALUATOR_H
...
void evaluator_init(Evaluator *evaluator);
Value evaluator_evaluate(Evaluator *evaluator, Stmt *stmts);
void value_print(Value value);

#endif

#ifdef EVALUATOR_IMPLEMENTATION
